...
<div class="modal fade" id="popup_modal"  tabindex="-1" role="dialog" aria-labelledby="popup_modal" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="form-group">
            ...
            <input autocomplete="off" type="number" id="rate_per_km" name="rate_per_km" class="form-control">
        </div>

        <div class="form-group">
            <label class="col-form-label">Rate Per Km with Loaders</label>
            <input autocomplete="off" type="number" id="rate_per_km_loaders" name="rate_per_km_loaders" class="form-control">
        </div>
...
function Delete(id,status){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/delete-service/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
