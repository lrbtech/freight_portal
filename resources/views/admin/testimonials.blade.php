...
<div class="modal fade" id="popup_modal"  tabindex="-1" role="dialog" aria-labelledby="popup_modal" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="form-group">
            ...
            <input autocomplete="off" type="text" id="location" name="location" class="form-control">
        </div>
...
$('.new-testimonials').addClass('active');
var action_type;
...
function Edit(id){
  $.ajax({
    url : '/admin/edit-testimonials/'+id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
      $('#modal-title').text('Update testimonials');
...
function Delete(id,status){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/delete-testimonials/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
