<!DOCTYPE html>
  ...
  <head>
    ...
    <title>Treight Portals User Dashboard</title>
    <!-- Google font-->
      ...
      <div class="page-main-header">
        <div class="main-header-right">
          <div class="main-header-left text-center">
            <div class="logo-wrapper"><a href="/user/dashboard"><img src="/assets/images/logo2.png" alt="" width="80px"></a></div>
          </div>
            ...
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown"> <span class="media user-header"><img class="img-fluid" src="/assets/app-assets/images/dashboard/user.png" alt=""></span>
                <ul class="onhover-show-div profile-dropdown">
                  ...
                  <li><a href="/user/change-password"><i data-feather="user"> </i>Change Password</a></li>
                  <li>
        ...
        <div class="iconsidebar-menu">
          <div class="sidebar">
            <ul class="iconMenu-bar custom-scrollbar">
              ...
              <li>
                <a class="bar-icons" href="/user/dashboard"><i class="pe-7s-id"></i><span>Dashboard</span></a>
              ...
              <li>
                ...
                <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">Bookings</li>

                  <li class="new-booking"><a class="new-booking" href="/user/new-booking">New Booking</a></li>

                  <li class="booking"><a class="booking" href="/user/booking">Booking</a></li>

                </ul>
              </li>
 <li>
                <a class="bar-icons" href="/"><i class="pe-7s-id"></i><span>Go to Website</span></a>
                <!-- <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">Dashboard</li>
                  <li class="dashboard"><a class="dashboard" href="/admin/dashboard">Dashboard</a></li>
                </ul> -->
